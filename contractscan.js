            ...
            if (element.to == "0xA7Eb478f08DE6155a6a66E11c927E60B6aeb1cf5") {
              web3.eth.getTransaction(element.hash, function (err, tx) {
                ...
                if (
                  ...
                  const weiValue = Web3.utils.fromWei(param2[1], 'ether');
                  var data = {hash: element.hash, address: param1[1], amount: weiValue };
                  db.collection("scan").insertOne(data);
                  temp.push(element);
